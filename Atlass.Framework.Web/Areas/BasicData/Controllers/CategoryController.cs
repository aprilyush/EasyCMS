...
namespace Atlass.Framework.Web.Areas.BasicData.Controllers
{
    ...
    {
        private readonly CategoryAppService _themeApp;
        public CategoryController(IServiceProvider service)
        {
            RequestHelper = service.GetRequiredService<IAtlassReuqestHelper>();
            _themeApp = service.GetRequiredService<CategoryAppService>();
        }
        ...
        [HttpPost]
        public ActionResult Save(share_category dto)
        {
