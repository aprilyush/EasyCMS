...
var sub = {
    editColumn: function() {
    	...
    	for (var dataIndex = 0; dataIndex < count; dataIndex++) {
    	    ...
    	    for (var i = 0; i < columns.length; i++) {
    	        ...
    	        if (!jutils.empty(inputValue.val())) {
    	            obj[key] = inputValue.val();
    	        } else if (!jutils.empty(selectValue.val())) {
    ...
    delColumn: function(column) {
    	sub.editColumn();
    	var subColumn = !jutils.empty(column) ? "index" : column;
    ...
    addColumn: function(row, tableId) {
    	var currentId = !jutils.empty(tableId) ? table.options.id : tableId;
    	table.set(currentId);
