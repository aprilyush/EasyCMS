...
(function ($) {
    ...
    var init_tree_container = function () {
        ...
        var checkedDomId=this.$target_element.idLabel+"_checkedIds";
        ...
        this.checked_val_element = $('<input type="hidden" id="' +checkedDomId+ '" name="' +checkedDomId+ '">').insertAfter(this.tree_container);
