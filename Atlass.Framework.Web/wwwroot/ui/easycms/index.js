...
$(function() {
    ...
    function menuItem() {
        ...
        // 选项卡菜单不存在
        if (flag) {
            var str = '<a href="javascript:;" class="active menuTab" data-id="' + dataId + '" data-href="'+dataUrl+'">' + menuName + ' <i class="fa fa-times-circle"></i></a>';
...
//获取前台角色的按钮权限
function getRoleButtonPermission(){
    $.ajax({
        url: '/admin/sysrole/getButtonPermission',
        async: false,//同步去请求
        type: 'get',
        dataType: 'json',
        ...
        success: function (res) {
                if(res.status){
                    window.buttonPermissionModel=res.data;
                }else{
                    window.buttonPermissionModel=null;
                }
        },
