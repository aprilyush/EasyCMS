...
CREATE TABLE `easy_log`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = MyISAM AUTO_INCREMENT = 500 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci ROW_FORMAT = Dynamic;
...
-- ----------------------------
INSERT INTO `hangfire_task` VALUES ('5eaabde6c1a509138ce04e80', '测试任务', '测试写日志，1小时写一次', '2020-06-08 16:51:18', 'Atlass.Framework.Jobs', 'TestJob', '0 */1 * * *', 1);
